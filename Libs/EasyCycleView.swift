...
@objc public protocol EasyCycleViewProtocol {
    ...
    @objc optional func setupCustomCell(_ cell: UICollectionViewCell, for index: NSInteger, cycleView: EasyCycleView)
}

public class EasyCycleView: UIView {

    private var reuseIdentifier: String = "EasyCycleViewCell"
    ...
    public var pageControlAlignment: EasyPageControlPosition = .center {
    ...
    /// delegate
    public var delegate: EasyCycleViewProtocol? {
        didSet {
            /// add by LeeYZ
            if delegate != nil {
                registerCell()
    ...
    //=============================================
    fileprivate var flowLayout: EasyCycleLayout!
    fileprivate var collectionView: UICollectionView!
    fileprivate var placeholderImgView: UIImageView!
    fileprivate var pageControl: EasyPageControl!
    ...
    private func registerCell() {
        ...
        if let customClass = delegate?.customCollectionViewCellClassForCycleScrollView?() {
            ...
            collectionView.register(EasyCycleViewCell.self, forCellWithReuseIdentifier: reuseIdentifier)
        }
    }
    
    private func addPageControl() {
        pageControl = EasyPageControl(frame: CGRect(x: 0, y: bounds.size.height - pageControlHeight, width: bounds.size.width, height: pageControlHeight))
...
extension EasyCycleView: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        /// modify by LeeYZ
        guard let cell = cycleCell as? EasyCycleViewCell else {
            return cycleCell
        }
        switch resourceType {
        case .image:
